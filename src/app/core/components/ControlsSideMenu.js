...
export default class ControlsSideMenu extends React.Component {
        ...
        return (
            <aside className="control-sidebar control-sidebar-dark">
                ...
                <ul className="nav nav-tabs nav-justified control-sidebar-tabs">
                    {/*<li className="active">
                        <a href="#control-sidebar-theme-demo-options-tab" data-toggle="tab"><i
                            className="fa fa-wrench"></i></a>
                    </li>*/}
                    <li><a href="#control-sidebar-home-tab" data-toggle="tab"><i className="fa fa-home"></i></a></li>
                    <li><a href="#control-sidebar-settings-tab" data-toggle="tab"><i className="fa fa-gears"></i></a>
                    </li>
                </ul>
                {/* Tab panes */}
                    ...
                    <div className="tab-pane" id="control-sidebar-settings-tab">
                        <form method="post">
                            ...
                            <div className="form-group">
                                <label className="control-sidebar-subheading">
                                    Delete chat history
                                    <a href="#" className="text-red pull-right"><i
