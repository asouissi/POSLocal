	...
	getStyles() {
		...
		switch (this.props.type) {
			case 'success':
				...
				styles.content = Object.assign({}, contentStyle, successStyle);
				break;
			...
			case 'error':
				...
				styles.content = Object.assign({}, contentStyle, errorStyle);
				break;
			...
			case 'warning':
				...
				styles.content = Object.assign({}, contentStyle, warningStyle);
				break;
...
function show(text, type, timeout) {
    let notificationComponent = document.getElementById(notificationWrapperId);
    if (notificationComponent && !notificationComponent.hasChildNodes()) {
